...
- <i class="fa fa-github"></i> [github.com/kunlei](github.com/kunlei)
...
- Proposed an improved algorithm framework based on multi-directional local search to approximate the Pareto frontier of multi-objective optimization problems. 
- Studied the impact of improving service consistency in vehicle routing problems with repeatable customer demands over multiple days.
- Suggested a branch-and-price algorithm to solve the consistent vehicle routing problem.
...
- Designed a tabu search and imperialist competitive algorithm to solve the process planning optimization problem in manufacturing systems. 
- Developed a imperialist competitive algorithm to address the mixed-model U-shaped assembly line balancing and sequencing problem.
...
- Supported the ocean procurement business to determine the optimal set of carriers on hundreds of lanes in order to minimizing total costs, achieved approximately *$90 million* cost savings for fiscal year 2021.
- Designed and developed an optimization engine based on column generation and mixed-integer programming to solve a very large scale transportation optimization problem on Walmart network.
...
Yuxiang Lian, Leilei Meng, Yifeng Wang, Chaoyong Zhang, *Kunlei Lian*, Yibo Wei

N/A

N/A

2020 International Conference on Urban Engineering and Management Science
